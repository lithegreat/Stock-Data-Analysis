...
def process_stock_data(file_path, window_sizes, epochs=20):
...
if __name__ == "__main__":
    ...
    stock_files = ['data/dax40.csv', 'data/dji.csv', 'data/ftse100.csv']
    ...
    for stock, res in final_results.items():
        ...
        for ws, result_dict in res.items():
            ...
            print(f"Window {ws}: Final Val Loss: {final_val_loss:.4f}")

    with open('final_results.pkl', 'wb') as f:
        pickle.dump(final_results, f)
    print("All the results have been save to final_results.pkl")